...
part 'program_dashboard.freezed.dart';
part 'program_dashboard.g.dart';

/// Dashboard data for a program.
@freezed
class ProgramDashboard with _$ProgramDashboard {
  /// Creates program dashboard data.
  const factory ProgramDashboard({
    // Top-level metrics
  ...
  factory ProgramDashboard.fromJson(Map<String, dynamic> json) =>
      _$ProgramDashboardFromJson(json);
}
