...
_$ProjectDashboardImpl _$$ProjectDashboardImplFromJson(
        Map<String, dynamic> json) =>
    _$ProjectDashboardImpl(
...
Map<String, dynamic> _$$ProjectDashboardImplToJson(
        _$ProjectDashboardImpl instance) =>
    <String, dynamic>{
