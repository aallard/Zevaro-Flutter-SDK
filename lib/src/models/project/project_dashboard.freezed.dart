...
part of 'project_dashboard.dart';
...
ProjectDashboard _$ProjectDashboardFromJson(Map<String, dynamic> json) {
  return _ProjectDashboard.fromJson(json);
}

/// @nodoc
mixin _$ProjectDashboard {
// Top-level metrics
  ...
  @JsonKey(ignore: true)
  $ProjectDashboardCopyWith<ProjectDashboard> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ProjectDashboardCopyWith<$Res> {
  factory $ProjectDashboardCopyWith(
          ProjectDashboard value, $Res Function(ProjectDashboard) then) =
      _$ProjectDashboardCopyWithImpl<$Res, ProjectDashboard>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ProjectDashboardCopyWithImpl<$Res, $Val extends ProjectDashboard>
    implements $ProjectDashboardCopyWith<$Res> {
  _$ProjectDashboardCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ProjectDashboardImplCopyWith<$Res>
    implements $ProjectDashboardCopyWith<$Res> {
  factory _$$ProjectDashboardImplCopyWith(_$ProjectDashboardImpl value,
          $Res Function(_$ProjectDashboardImpl) then) =
      __$$ProjectDashboardImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int pendingDecisionCount,
...
/// @nodoc
class __$$ProjectDashboardImplCopyWithImpl<$Res>
    extends _$ProjectDashboardCopyWithImpl<$Res, _$ProjectDashboardImpl>
    implements _$$ProjectDashboardImplCopyWith<$Res> {
  __$$ProjectDashboardImplCopyWithImpl(_$ProjectDashboardImpl _value,
      $Res Function(_$ProjectDashboardImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ProjectDashboardImpl(
      pendingDecisionCount: null == pendingDecisionCount
          ? _value.pendingDecisionCount
          : pendingDecisionCount // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$ProjectDashboardImpl implements _ProjectDashboard {
  const _$ProjectDashboardImpl(
  ...
  factory _$ProjectDashboardImpl.fromJson(Map<String, dynamic> json) =>
      _$$ProjectDashboardImplFromJson(json);
...
// Activity feed
  ...
  @override
  String toString() {
    return 'ProjectDashboard(pendingDecisionCount: $pendingDecisionCount, slaBreachedDecisionCount: $slaBreachedDecisionCount, activeOutcomeCount: $activeOutcomeCount, outcomeValidationPercentage: $outcomeValidationPercentage, runningExperimentCount: $runningExperimentCount, avgDecisionTimeHours: $avgDecisionTimeHours, avgDecisionTimeTrend: $avgDecisionTimeTrend, decisionQueue: $decisionQueue, decisionVelocity: $decisionVelocity, outcomeProgress: $outcomeProgress, activityFeed: $activityFeed)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ProjectDashboardImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ProjectDashboardImplCopyWith<_$ProjectDashboardImpl> get copyWith =>
      __$$ProjectDashboardImplCopyWithImpl<_$ProjectDashboardImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ProjectDashboardImplToJson(
      this,
    );
  }
}

abstract class _ProjectDashboard implements ProjectDashboard {
  const factory _ProjectDashboard(
      {final int pendingDecisionCount,
      final int slaBreachedDecisionCount,
      final int activeOutcomeCount,
      final double outcomeValidationPercentage,
      ...
      final List<DashboardActivityItem> activityFeed}) = _$ProjectDashboardImpl;

  factory _ProjectDashboard.fromJson(Map<String, dynamic> json) =
      _$ProjectDashboardImpl.fromJson;
